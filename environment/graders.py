...
def grade_task_1(action: Action) -> Reward:
    ...
    if "rent" in analysis_text:
        return Reward(score=0.9, feedback="Correctly identified 'rent' as the highest expense.")
    return Reward(score=0.1, feedback="Failed to identify 'rent' as the highest expense.")
